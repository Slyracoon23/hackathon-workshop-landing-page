...
const Home: NextPage = () => {
  return (
    ...
    >
      ...
      >
        <div className="w-full container mx-auto p-6 margin:h-0">
        ...
        <div className="container pt-24 md:pt-0 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center p-0">
